-- Exams
INSERT INTO quiz (name, description) VALUES ('Java: Beginner', 'This quiz offers test on the basics of the Java language.');
INSERT INTO quiz (name, description) VALUES ('Java: Intermediate', 'This quiz offers test on the more sophisticated capabilities than the basics of the Java language.');
INSERT INTO quiz (name, description) VALUES ('Java: Advanced', 'This quiz offers test on the more advanced concepts and nuances of the Java language.');

-- Java Beginner Questions with Answers
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (1, 'What is the output of the following program?',
'public class Team {
  private int size = 4;
...
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (1, 'Which method overrides a method in the super class?',
'public class Department {
...
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (1, 'Which method hides a method in the super class?',
'public class Department {
  static void testing(String requirement) {
  }
  static void coding(String requirement) {
...
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (1, 'What does method coding in the sub class do?',
'public class Department {
  static void testing(String requirement) {
  }
  static void coding(String requirement) {
...
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (2, 'What is the output of the following program?',
'public class Team {
  protected int id = 4;
...
INSERT INTO question (quiz_id, name, code, multi_answer) VALUES (3, 'What is the output of the following program?',
